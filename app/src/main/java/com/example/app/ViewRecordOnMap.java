...
//
//public class ViewRecordOnMap extends AppCompatActivity {
...
//        mapView.setMap(map);
//        mapView.setViewpoint(new Viewpoint(31.02700, 73.80543, 18922223.819286));
...
//        hospitalMarker.setVisibility(View.GONE);
//        }
...
//    }
//    @SuppressLint("Range")
//    private void getmarkerfordoctor() {
//        try {
...
//                    " WHERE Record.DiseaseID = '" + PERF_DIS + "'", this, new OnlineDB.OnGetDataListener() {
//                @Override
//                public void onDataRetrieved(Cursor cursor) {
//                    Drawable def = ContextCompat.getDrawable(getBaseContext(), R.drawable.diseaseblueicon);
//                    BitmapDrawable defDrawable = (BitmapDrawable) def;
...
//
//        AlertDialog.Builder builder = new AlertDialog.Builder(ViewRecordOnMap.this);
